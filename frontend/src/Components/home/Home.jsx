    ...
    return (
        <div className="lg:px-14 sm:px-8 px-4">
           ...
           <div className="py-5">
            <div className="flex flex-col justify-center items-center space-y-2 ">
                <h1 className="text-slate-800 text-4x1 font-bold ">Products</h1>
                    <span className="text-slate-700">
                         Discover our handpicked collection of top-rated items just for you !
                    </span>  
            </div>
            ...
            <div  className="pb-6 pt-14 grid 2xl:-cols-4 lg:grid-cols-3 sm:grid-cols-2 gap-y-6 gap-x-6">
                {products && 
                products?.slice(0,8) 
                .map((item,i)=>
